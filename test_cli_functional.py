...
def test_cli_basic_functionality():
    ...
    try:
        ...
        args = parser.parse_args(
            ["process", "/test.pdf", "--ensemble", "--llm-extractor", "deepseek"]
        )
        ...
        args = parser.parse_args(
            ["batch", "/input", "--output-dir", "/output", "--max-files", "10"]
        )
...
def test_cli_with_mock_data():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            pdf_path.write_text("Mock report content")
            ...
            with patch("cli.report_reader.ReportReader") as mock_reader_class:
                ...
                result = cli.process_single_pdf(
                    pdf_path=str(pdf_path), output_dir=str(output_dir), verbose=False
                )
                ...
                print("✅ Single report processing works correctly")
...
def test_cli_error_handling():
    ...
    try:
        ...
        result = cli.process_single_pdf(pdf_path="/nonexistent/file.pdf", verbose=False)
