...
class ModelConfig:
    ...
    MODELS = [
        ...
        {"name": "llama3.2:1b", "priority": 2, "timeout": 20, "description": "Llama 3.2 1B - kompakt und effizient"},
        {
...
"""
        ...
        for attempt in range(max_model_attempts):
            try:
                ...
                try:
                    ...
                    logger.info(f"Erfolgreich extrahiert: {metadata.patient_name}, Alter: {metadata.patient_age}, Datum: {metadata.examination_date}")
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {"current_model": self.current_model, "available_models": self.available_models, "total_models": len(self.available_models)}
    ...
    *,
    ...
    payload = {
        ...
        "messages": [
            {
                "role": "system",
                "content": ("You are a medical report extraction assistant. Return only JSON with patient metadata fields."),
            },
