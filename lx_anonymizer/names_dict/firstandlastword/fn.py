...
def extract_first_words(file_path: str | PathLike[str]) -> tuple[list[str], list[str]]:
...
if __name__ == "__main__":
    input_file_path = (
        "first_and_last_names_neutral_ascii.txt"  # Replace with your input file path
    )
    first_words_output_file_path = "first_names_neutral_ascii.txt"  # Replace with your first words output file path
    remaining_lines_output_file_path = (
        "fn_male_remaining.txt"  # Replace with your remaining lines output file path
    )
