...
print(
    f"✅ _mask_video_streaming method: {hasattr(frame_cleaner, '_mask_video_streaming')}"
)
print(
    f"✅ _create_mask_config_from_roi method: {hasattr(frame_cleaner, '_create_mask_config_from_roi')}"
)
